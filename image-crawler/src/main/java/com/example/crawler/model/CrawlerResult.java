...
public class CrawlerResult {
    ...
    /** 每个成功下载的 URL 对应的实际文件名（key=URL, value=filename，含扩展名） */
    private java.util.Map<String, String> fileNames = new java.util.HashMap<>();
    ...
    public java.util.Map<String, String> getFileNames() {
        return fileNames;
    }

    public void setFileNames(java.util.Map<String, String> fileNames) {
